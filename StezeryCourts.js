            ...
            for (const { timeFromString, timeToString } of timeBlocks) {
                ...
                if (match) {
                    ...
                    if (classAttr.includes("booked")) {
                        console.log(`Court ${courtNumber} is booked ${timeFromString}-${timeToString} on ${dateString}`);
                        return;
                    }
                    ...
                    console.log(`No matching time slot: Court ${courtNumber} ${timeFromString}-${timeToString}`);
                    return;
                }
            }

            console.log("Veri Values to Store:", veriValues);
